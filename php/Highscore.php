...
$query = "SELECT u.name, u.id ,s.datetime AS untill_date, SUM(s.score) AS wins FROM Users u INNER JOIN Score s ON s.user_id=u.id Where s.datetime >= '$date' GROUP BY u.name";
